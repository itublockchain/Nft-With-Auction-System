...
const Home = () => {
    ...
    const randomId = random.toString().slice(3,19);
            ...
            <div style={{
                ...
                <div className="auction__title ">
                    ...
                    <Row>
                        ...
                        <Col><h2 style={{textAlign: "center"}} >Are You Bidder?</h2></Col>                
                            ...
                            {loading ? (
                                <div>
                                  ...
                                  <div>
                                      ...
                                      <img alt= "" src={image} style={{borderRadius: "0.3rem", border: "3px solid #000", width: '300px'}} />                                
                ...
                <div className="auction__content auction__thumbnail">
                    <Card className="p-3">
                        ...
                        <img alt= "" src={Contract} style={{alignItems:"center", textAlign:"center" ,borderRadius: "0.3rem", width: '472px'}} />                                
                        </div>
                        : <div style={{textAlign:"center"}}>
                        <img alt= "" src={Contract} style={{alignItems:"center", textAlign:"center" ,borderRadius: "0.3rem", width: '273px'}} />                                
                        </div>}
